      ...
      body: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Text("My Cycles:", style: TextStyle(color: Colors.grey[800], fontWeight: FontWeight.bold),),
          ),
            ...
            child: GestureDetector(
              ...
              onTap: (){
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => DetailOfHouse(1)
                ));
              }
            )
          ),*/
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  SizedBox(height: 8,),
                                  //Text("300 Rs /day", style: TextStyle(fontSize: 18, color: Colors.green, fontWeight: FontWeight.bold),),
                                ],
                              ),
                            ),
